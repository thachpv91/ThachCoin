...
const string strMessageMagic = "ThachCoin Signed Message:\n";
...
{
    int64 nSubsidy = 50 * COIN; //Amt of coins per block // thachpv changed
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // ThachCoin: 0.35 days
static const int64 nTargetSpacing = 15; // ThachCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ThachCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ThachCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
